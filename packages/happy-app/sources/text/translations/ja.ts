...
export const ja: TranslationStructure = {
    ...
    newSession: {
        ...
        preset: {
            ...
            noProfiles: 'このマシンにはプリセットがありません。ホストの ~/.happy/profiles.json で定義してください（デーモンのドキュメントを参照）。',
    ...
    fleet: {
        ...
        cleanup: {
            ...
            doneTitle: '整理が完了しました',
            nothingTitle: '整理するものはありません',
            nothingBody: '7日以上前の非アクティブなセッションはありません。',
        },
    },
    ...
    subscriptions: {
        title: 'サブスクリプション',
        machineRowTitle: 'サブスクリプション',
        machineRowSubtitle: 'このマシン上の Claude アカウント',
        sectionAccounts: 'アカウント',
        accountsFooter: 'このマシンには複数の Claude サブスクリプションがあります。クラウドセッションは選択したアカウント経由でルーティングされます。選択がない場合はデフォルトが使用されます。',
        defaultBadge: 'デフォルト',
        noAccounts: 'アカウントがまだありません',
        noAccountsSubtitle: 'Claude サブスクリプションを追加して、クラウドセッションをそれ経由でルーティングします。',
        addAccount: 'アカウントを追加',
        usage5h: '5時間',
        usage7d: '7日間',
        usageUnknown: '使用量不明',
        accountActionsTitle: ({ name }: { name: string }) => `アカウント: ${name}`,
        setDefault: 'デフォルトに設定',
        remove: 'アカウントを削除',
        removeConfirmTitle: 'アカウントを削除しますか？',
        removeConfirmMessage: ({ name }: { name: string }) => `「${name}」はこのマシンのボールトから削除されます。実行中のセッションは切り替えられるまで動作を続けます。`,
        migrateRow: '実行中のセッションを移行',
        addTitle: 'アカウントを追加',
        addInstructionsTitle: 'セットアップトークンを取得',
        addInstructionsRun: 'マシンで `claude setup-token` を実行してログインします。',
        addInstructions: '以下にトークンを貼り付けてください。ボールトに暗号化され、デーモンから外に出ることはありません。',
        nameLabel: '名前',
        namePlaceholder: '例: 仕事、個人',
        nameRequired: 'このアカウントの名前を入力してください。',
        tokenLabel: 'セットアップトークン',
        tokenPlaceholder: 'ここに claude setup-token を貼り付け',
        tokenRequired: 'セットアップトークンを貼り付けてください。',
        makeDefault: 'デフォルトにする',
        addButton: 'アカウントを追加',
        migrateTitle: 'セッションを移行',
        migrateInstructions: '実行中のセッションを選択して別のアカウントに切り替えます。切り替えはライブで行われます — 再起動は不要です。',
        migrateNoSessions: 'このマシンに実行中のセッションはありません。',
        migrateUnbound: 'アカウントに紐付けられていません',
        migrateSelectTarget: '切り替え先',
        migrateButton: ({ count }: { count: number }) => `${count} 個のセッションを切り替え`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} 個を切り替え、${skipped} 個をスキップしました。`,
    ...
    run: {
        ...
        empty: '自律実行はまだありません',
        submit: 'ジョブを送信',
        submitTitle: '新しい自律ジョブ',
        fieldDirectory: 'ディレクトリ',
        fieldPrompt: 'プロンプト',
        fieldTier: 'ティア',
        fieldPreset: 'プリセット',
        fieldTrigger: 'トリガー',
        ...
        tierTrusted: '信頼済み (自律)',
        tierSupervised: '監視付き (確認あり)',
        stop: '停止',
        stopConfirm: 'このジョブを停止しますか？プロセスはSIGTERMを受け取り、5秒後にSIGKILLされます。',
        statusPending: '保留中',
        statusRunning: '実行中',
        statusSucceeded: '成功',
        statusFailed: '失敗',
        statusDead: '終了',
        statusNeedsAttention: '要対応',
        attempts: ({ n, max }: { n: number; max: number }) => `試行 ${n}/${max}`,
        costLine: ({ usd }: { usd: string }) => `コスト: $${usd}`,
        budgetLine: ({ usd }: { usd: string }) => `予算: $${usd}`,
    ...
    cron: {
        title: 'スケジュール',
        empty: 'cronスケジュールはまだありません',
        submit: 'スケジュールを作成',
        submitTitle: '新しいcronスケジュール',
        fieldCronExpr: 'cron式',
        fieldDirectory: 'ディレクトリ',
        fieldPrompt: 'プロンプト',
        fieldTier: 'ティア',
        ...
        fieldTurns: '最大ターン数',
        fieldTimeout: 'タイムアウト（分）',
        fieldAllowedTools: '許可されたツール',
        tierTrusted: '信頼済み（自律）',
        tierSupervised: '監視あり（確認）',
        delete: 'スケジュールを削除',
        deleteConfirm: 'このスケジュールを削除しますか？以降の実行はキューに追加されません。',
        deleteError: 'スケジュールを削除できませんでした。もう一度お試しください。',
        statusEnabled: '有効',
        statusDisabled: '無効',
        cronExprPlaceholder: '例: */30 * * * *',
        cronExprHint: '5フィールドのcron式。デーモンのタイムゾーンで評価されます。',
        cronExprInvalid: 'cron式にはスペース区切りの5つのフィールドが必要です（例: */30 * * * *）。',
        promptPlaceholder: 'エージェントに何をしてほしいか説明してください…',
    ...
    event: {
        title: 'イベントサブスクリプション',
        empty: 'イベントサブスクリプションはまだありません',
        submit: '新しいサブスクリプション',
        submitTitle: '新しいイベントサブスクリプション',
        fieldEventType: 'イベントタイプ',
        fieldMatchKey: '一致キー',
        fieldDirectory: 'ディレクトリ',
        fieldPrompt: 'プロンプト',
        fieldTier: 'ティア',
        ...
        tierSupervised: '監視あり（確認）',
        delete: 'サブスクリプションを削除',
        deleteConfirm: 'このサブスクリプションを削除しますか？以降の実行はトリガーされません。',
        deleteError: 'サブスクリプションを削除できませんでした。もう一度お試しください。',
        statusEnabled: '有効',
        statusDisabled: '無効',
        submitSuccess: 'サブスクリプションを作成しました。',
        eventTypeHint: 'このバージョンでは git.commit のみがサポートされています。',
        matchKeyPlaceholder: '任意、例: ブランチ名',
        matchKeyHint: 'イベントのペイロードがこのキーに一致する場合のみ発火します。空欄の場合はすべてに一致します。',
        promptPlaceholder: 'エージェントに何をしてほしいか説明してください…',
        allowedToolsPlaceholder: '任意、カンマ区切り',
        allowedToolsHint: 'エージェントをこれらのツールに制限します。空欄の場合はプリセットの既定値を使用します。',
        fieldDispositionTopic: '処理トピック',
