...
export const ca: TranslationStructure = {
    ...
    connect: {
        ...
        restoreInstructions: 'Introdueix la teva clau secreta per restaurar l\'accés al teu compte.',
        ...
        qrLinkInstructions: '1. Obre Happy al teu dispositiu mòbil\n2. Ves a Configuració → Compte\n3. Toca "Vincula un dispositiu nou"\n4. Escaneja aquest codi QR',
    ...
    subscriptions: {
        title: 'Subscripcions',
        machineRowTitle: 'Subscripcions',
        machineRowSubtitle: 'Comptes de Claude en aquesta màquina',
        sectionAccounts: 'Comptes',
        accountsFooter: 'Diverses subscripcions de Claude en aquesta màquina. Les sessions al núvol s\'encaminen a través del compte escollit; s\'utilitza el predeterminat quan no se\'n tria cap.',
        defaultBadge: 'Predeterminat',
        noAccounts: 'Encara no hi ha comptes',
        noAccountsSubtitle: 'Afegeix una subscripció de Claude per encaminar-hi les sessions al núvol.',
        addAccount: 'Afegeix compte',
        usage5h: '5 hores',
        usage7d: '7 dies',
        usageUnknown: 'Ús desconegut',
        accountActionsTitle: ({ name }: { name: string }) => `Compte: ${name}`,
        setDefault: 'Estableix com a predeterminat',
        remove: 'Elimina compte',
        removeConfirmTitle: 'Voleu eliminar el compte?',
        removeConfirmMessage: ({ name }: { name: string }) => `«${name}» s\'eliminarà del magatzem d\'aquesta màquina. Les sessions en execució continuen funcionant fins que es canvien.`,
        migrateRow: 'Migra les sessions en execució',
        addTitle: 'Afegeix compte',
        addInstructionsTitle: 'Obtén un testimoni de configuració',
        addInstructionsRun: 'Executa `claude setup-token` a la màquina i inicia la sessió.',
        addInstructions: 'Enganxa el testimoni a continuació. Es xifra al magatzem i mai no surt del dimoni.',
        nameLabel: 'Nom',
        namePlaceholder: 'p. ex. feina, personal',
        nameRequired: 'Introdueix un nom per a aquest compte.',
        tokenLabel: 'Testimoni de configuració',
        tokenPlaceholder: 'Enganxa aquí el claude setup-token',
        tokenRequired: 'Enganxa el testimoni de configuració.',
        makeDefault: 'Fes-lo predeterminat',
        addButton: 'Afegeix compte',
        migrateTitle: 'Migra sessions',
        migrateInstructions: 'Selecciona sessions en execució i canvia-les a un altre compte. El canvi és en directe — sense reinici.',
        migrateNoSessions: 'No hi ha sessions en execució en aquesta màquina.',
        migrateUnbound: 'No vinculada a cap compte',
        migrateSelectTarget: 'Canvia a',
        migrateButton: ({ count }: { count: number }) => `Canvia ${count} ${plural({ count, singular: 'sessió', plural: 'sessions' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} canviades, ${skipped} omeses.`,
    ...
    cron: {
        ...
        cronExprInvalid: 'Una expressió cron necessita cinc camps separats per espais (p. ex. */30 * * * *).',
        promptPlaceholder: 'Descriu el que vols que faci l’agent…',
    ...
    event: {
        title: 'Subscripcions a Esdeveniments',
        empty: 'Encara no hi ha subscripcions a esdeveniments',
        submit: 'Nova subscripció',
        submitTitle: 'Nova subscripció a esdeveniment',
        fieldEventType: 'Tipus d’esdeveniment',
        fieldMatchKey: 'Clau de coincidència',
        fieldDirectory: 'Directori',
        fieldPrompt: 'Prompt',
        fieldTier: 'Nivell',
        fieldPreset: 'Predefinició',
        fieldBudget: 'Pressupost màxim (USD)',
        fieldTurns: 'Torns màxims',
        fieldTimeout: 'Temps d’espera (minuts)',
        fieldAllowedTools: 'Eines permeses',
        tierTrusted: 'De confiança (autònom)',
        tierSupervised: 'Supervisat (pregunta)',
        delete: 'Elimina la subscripció',
        deleteConfirm: 'Voleu eliminar aquesta subscripció? No s’activarà cap execució més.',
        deleteError: 'No s’ha pogut eliminar la subscripció. Torneu-ho a provar.',
        statusEnabled: 'Activat',
        statusDisabled: 'Desactivat',
        submitSuccess: 'Subscripció creada.',
        eventTypeHint: 'En aquesta versió només s’admet git.commit.',
        matchKeyPlaceholder: 'Opcional, p. ex. el nom d’una branca',
        matchKeyHint: 'Activa només quan la càrrega de l’esdeveniment coincideixi amb aquesta clau. Deixeu-ho buit per coincidir amb tots.',
        promptPlaceholder: 'Descriu el que vols que faci l’agent…',
        allowedToolsPlaceholder: 'Opcional, separades per comes',
        allowedToolsHint: 'Restringeix l’agent a aquestes eines. Deixeu-ho buit per al valor predeterminat de la predefinició.',
        fieldDispositionTopic: 'Tema de disposició',
