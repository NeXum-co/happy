...
export const ru: TranslationStructure = {
    ...
    subscriptions: {
        title: 'Подписки',
        machineRowTitle: 'Подписки',
        machineRowSubtitle: 'Аккаунты Claude на этой машине',
        sectionAccounts: 'Аккаунты',
        accountsFooter: 'Несколько подписок Claude на этой машине. Облачные сессии направляются через выбранный аккаунт; если ни один не выбран, используется аккаунт по умолчанию.',
        defaultBadge: 'По умолчанию',
        noAccounts: 'Пока нет аккаунтов',
        noAccountsSubtitle: 'Добавьте подписку Claude, чтобы направлять облачные сессии через неё.',
        addAccount: 'Добавить аккаунт',
        usage5h: '5 часов',
        usage7d: '7 дней',
        usageUnknown: 'Использование неизвестно',
        accountActionsTitle: ({ name }: { name: string }) => `Аккаунт: ${name}`,
        setDefault: 'Сделать по умолчанию',
        remove: 'Удалить аккаунт',
        removeConfirmTitle: 'Удалить аккаунт?',
        removeConfirmMessage: ({ name }: { name: string }) => `«${name}» будет удалён из хранилища этой машины. Запущенные сессии продолжат работать, пока их не переключат.`,
        migrateRow: 'Перенести запущенные сессии',
        addTitle: 'Добавить аккаунт',
        addInstructionsTitle: 'Получите токен настройки',
        addInstructionsRun: 'Выполните `claude setup-token` на машине и войдите в систему.',
        addInstructions: 'Вставьте токен ниже. Он шифруется в хранилище и никогда не покидает демон.',
        nameLabel: 'Имя',
        namePlaceholder: 'напр. работа, личное',
        nameRequired: 'Введите имя для этого аккаунта.',
        tokenLabel: 'Токен настройки',
        tokenPlaceholder: 'Вставьте сюда claude setup-token',
        tokenRequired: 'Вставьте токен настройки.',
        makeDefault: 'Сделать по умолчанию',
        addButton: 'Добавить аккаунт',
        migrateTitle: 'Перенести сессии',
        migrateInstructions: 'Выберите запущенные сессии и переключите их на другой аккаунт. Переключение происходит на лету — без перезапуска.',
        migrateNoSessions: 'Нет запущенных сессий на этой машине.',
        migrateUnbound: 'Не привязано к аккаунту',
        migrateSelectTarget: 'Переключить на',
        migrateButton: ({ count }: { count: number }) => `Переключить ${count} ${plural({ count, one: 'сессию', few: 'сессии', many: 'сессий' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} переключено, ${skipped} пропущено.`,
        migrateFailed: 'Не удалось переключить выбранные сессии.',
        migrateDoneTitle: 'Сессии перенесены',
        sessionPid: ({ pid }: { pid: number }) => `PID ${pid}`,
        burnPolicy: {
            title: 'Политика переключения',
            enable: 'Автопереключение аккаунтов',
            threshold: ({ pct }: { pct: number }) => `Переключать при ${pct}% использования`,
            order: 'Порядок переключения',
            hint: 'Когда аккаунт достигает порога, новые и текущие облачные сессии переходят на следующий аккаунт со свободным лимитом. Измените порядок аккаунтов, чтобы задать приоритет.',
            moveUp: 'Вверх',
            moveDown: 'Вниз',
        },
    },
    ...
    run: {
        ...
        fieldUntrustedInput: 'Ненадёжный ввод',
        untrustedInputHint: 'Выберите «Да», если задача обрабатывает содержимое из ненадёжного источника (внешние репозитории, веб, сторонние данные). Задача уровня trusted, помеченная как ненадёжная, удерживается для вашего одобрения вместо запуска с полными правами.',
