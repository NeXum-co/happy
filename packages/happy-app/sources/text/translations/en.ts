...
export const en: TranslationStructure = {
    ...
    subscriptions: {
        title: 'Subscriptions',
        machineRowTitle: 'Subscriptions',
        machineRowSubtitle: 'Claude accounts on this machine',
        sectionAccounts: 'Accounts',
        accountsFooter: 'Multiple Claude subscriptions on this machine. Cloud sessions route through the chosen account; the default is used when none is picked.',
        defaultBadge: 'Default',
        noAccounts: 'No accounts yet',
        noAccountsSubtitle: 'Add a Claude subscription to route cloud sessions through it.',
        ...
        removeConfirmMessage: ({ name }: { name: string }) => `'${name}' will be removed from this machine's vault. Running sessions keep working until they are switched.`,
        migrateRow: 'Migrate running sessions',
        addTitle: 'Add account',
        addInstructionsTitle: 'Get a setup token',
        addInstructionsRun: 'Run `claude setup-token` on the machine and log in.',
        addInstructions: 'Paste the token below. It is encrypted into the vault and never leaves the daemon.',
        nameLabel: 'Name',
        namePlaceholder: 'e.g. work, personal',
        nameRequired: 'Enter a name for this account.',
        tokenLabel: 'Setup token',
        tokenPlaceholder: 'Paste the claude setup-token here',
        tokenRequired: 'Paste the setup token.',
        makeDefault: 'Make default',
        addButton: 'Add account',
        migrateTitle: 'Migrate sessions',
        migrateInstructions: 'Select running sessions and switch them to another account. The switch is live — no restart.',
        migrateNoSessions: 'No running sessions on this machine.',
        migrateUnbound: 'Not bound to an account',
        migrateSelectTarget: 'Switch to',
        migrateButton: ({ count }: { count: number }) => count === 1 ? 'Switch 1 session' : `Switch ${count} sessions`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} switched, ${skipped} skipped.`,
