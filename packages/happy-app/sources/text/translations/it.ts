...
export const it: TranslationStructure = {
    ...
    newSession: {
        ...
        preset: {
            ...
            noProfiles: 'Nessun preset su questa macchina. Definiscili in ~/.happy/profiles.json sull\'host (vedi la documentazione del daemon).',
    ...
    fleet: {
        ...
        cleanup: {
            ...
            doneTitle: 'Pulizia completata',
            nothingTitle: 'Niente da pulire',
            nothingBody: 'Non ci sono sessioni inattive più vecchie di 7 giorni.',
        },
    },
    ...
    subscriptions: {
        title: 'Abbonamenti',
        machineRowTitle: 'Abbonamenti',
        machineRowSubtitle: 'Account Claude su questa macchina',
        sectionAccounts: 'Account',
        accountsFooter: 'Più abbonamenti Claude su questa macchina. Le sessioni cloud vengono instradate attraverso l\'account scelto; quando non ne viene scelto nessuno, viene usato quello predefinito.',
        defaultBadge: 'Predefinito',
        noAccounts: 'Ancora nessun account',
        noAccountsSubtitle: 'Aggiungi un abbonamento Claude per instradare le sessioni cloud attraverso di esso.',
        addAccount: 'Aggiungi account',
        usage5h: '5 ore',
        usage7d: '7 giorni',
        usageUnknown: 'Utilizzo sconosciuto',
        accountActionsTitle: ({ name }: { name: string }) => `Account: ${name}`,
        setDefault: 'Imposta come predefinito',
        remove: 'Rimuovi account',
        removeConfirmTitle: 'Rimuovere l\'account?',
        removeConfirmMessage: ({ name }: { name: string }) => `«${name}» verrà rimosso dal vault di questa macchina. Le sessioni in esecuzione continuano a funzionare finché non vengono cambiate.`,
        migrateRow: 'Migra le sessioni in esecuzione',
        addTitle: 'Aggiungi account',
        addInstructionsTitle: 'Ottieni un token di configurazione',
        addInstructionsRun: 'Esegui `claude setup-token` sulla macchina e accedi.',
        addInstructions: 'Incolla il token qui sotto. Viene cifrato nel vault e non lascia mai il demone.',
        nameLabel: 'Nome',
        namePlaceholder: 'es. lavoro, personale',
        nameRequired: 'Inserisci un nome per questo account.',
        tokenLabel: 'Token di configurazione',
        tokenPlaceholder: 'Incolla qui il claude setup-token',
        tokenRequired: 'Incolla il token di configurazione.',
        makeDefault: 'Rendi predefinito',
        addButton: 'Aggiungi account',
        migrateTitle: 'Migra sessioni',
        migrateInstructions: 'Seleziona le sessioni in esecuzione e passale a un altro account. Il passaggio è in tempo reale — nessun riavvio.',
        migrateNoSessions: 'Nessuna sessione in esecuzione su questa macchina.',
        migrateUnbound: 'Non associata a un account',
        migrateSelectTarget: 'Passa a',
        migrateButton: ({ count }: { count: number }) => `Sposta ${count} ${plural({ count, singular: 'sessione', plural: 'sessioni' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} spostate, ${skipped} saltate.`,
    ...
    cron: {
        ...
        fieldTurns: 'Turni massimi',
        fieldTimeout: 'Timeout (minuti)',
        fieldAllowedTools: 'Strumenti consentiti',
        ...
        deleteError: 'Impossibile eliminare la pianificazione. Riprova.',
        ...
        cronExprInvalid: 'Un’espressione cron richiede cinque campi separati da spazi (es. */30 * * * *).',
        promptPlaceholder: 'Descrivi cosa vuoi che faccia l’agente…',
    ...
    event: {
        title: 'Sottoscrizioni Eventi',
        empty: 'Nessuna sottoscrizione eventi',
        submit: 'Nuova sottoscrizione',
        submitTitle: 'Nuova sottoscrizione evento',
        fieldEventType: 'Tipo di evento',
        fieldMatchKey: 'Chiave di corrispondenza',
        fieldDirectory: 'Directory',
        fieldPrompt: 'Prompt',
        fieldTier: 'Livello',
        fieldPreset: 'Preset',
        ...
        tierTrusted: 'Affidabile (autonomo)',
        tierSupervised: 'Supervisionato (chiede)',
        delete: 'Elimina sottoscrizione',
        deleteConfirm: 'Eliminare questa sottoscrizione? Non verranno più attivate esecuzioni.',
        deleteError: 'Impossibile eliminare la sottoscrizione. Riprova.',
        statusEnabled: 'Abilitato',
        statusDisabled: 'Disabilitato',
        submitSuccess: 'Sottoscrizione creata.',
        eventTypeHint: 'In questa versione è supportato solo git.commit.',
        matchKeyPlaceholder: 'Facoltativo, es. il nome di un branch',
        matchKeyHint: 'Attiva solo quando il payload dell’evento corrisponde a questa chiave. Lascia vuoto per corrispondere a tutti.',
        promptPlaceholder: 'Descrivi cosa vuoi che faccia l’agente…',
        allowedToolsPlaceholder: 'Facoltativo, separati da virgola',
        allowedToolsHint: 'Limita l’agente a questi strumenti. Lascia vuoto per il valore predefinito del preset.',
        fieldDispositionTopic: 'Argomento di disposizione',
