...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        createDirectoryBody: ({ directory }: { directory: string }) => `O diretório '${directory}' não existe. Deseja criá-lo?`,
        preset: {
            tabCustom: 'Personalizada',
            tabPreset: 'Preset',
            chooseProfile: 'Escolha um preset',
            noProfiles: 'Nenhum preset nesta máquina. Defina-os em ~/.happy/profiles.json no host (consulte a documentação do daemon).',
    ...
    fleet: {
        ...
        cleanup: {
            ...
            nothingTitle: 'Nada para limpar',
            nothingBody: 'Não há sessões inativas com mais de 7 dias.',
        },
    },
    ...
    subscriptions: {
        title: 'Assinaturas',
        machineRowTitle: 'Assinaturas',
        machineRowSubtitle: 'Contas do Claude nesta máquina',
        sectionAccounts: 'Contas',
        accountsFooter: 'Várias assinaturas do Claude nesta máquina. As sessões na nuvem são roteadas pela conta escolhida; a padrão é usada quando nenhuma é selecionada.',
        defaultBadge: 'Padrão',
        noAccounts: 'Ainda sem contas',
        noAccountsSubtitle: 'Adicione uma assinatura do Claude para rotear as sessões na nuvem por ela.',
        addAccount: 'Adicionar conta',
        usage5h: '5 horas',
        usage7d: '7 dias',
        usageUnknown: 'Uso desconhecido',
        accountActionsTitle: ({ name }: { name: string }) => `Conta: ${name}`,
        setDefault: 'Definir como padrão',
        remove: 'Remover conta',
        removeConfirmTitle: 'Remover conta?',
        removeConfirmMessage: ({ name }: { name: string }) => `"${name}" será removida do cofre desta máquina. As sessões em execução continuam funcionando até serem trocadas.`,
        migrateRow: 'Migrar sessões em execução',
        addTitle: 'Adicionar conta',
        addInstructionsTitle: 'Obtenha um token de configuração',
        addInstructionsRun: 'Execute `claude setup-token` na máquina e faça login.',
        addInstructions: 'Cole o token abaixo. Ele é criptografado no cofre e nunca sai do daemon.',
        nameLabel: 'Nome',
        namePlaceholder: 'ex. trabalho, pessoal',
        nameRequired: 'Informe um nome para esta conta.',
        tokenLabel: 'Token de configuração',
        tokenPlaceholder: 'Cole o claude setup-token aqui',
        tokenRequired: 'Cole o token de configuração.',
        makeDefault: 'Tornar padrão',
        addButton: 'Adicionar conta',
        migrateTitle: 'Migrar sessões',
        migrateInstructions: 'Selecione sessões em execução e troque-as para outra conta. A troca é ao vivo — sem reinício.',
        migrateNoSessions: 'Nenhuma sessão em execução nesta máquina.',
        migrateUnbound: 'Não vinculada a uma conta',
        migrateSelectTarget: 'Trocar para',
        migrateButton: ({ count }: { count: number }) => `Trocar ${count} ${plural({ count, singular: 'sessão', plural: 'sessões' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} trocadas, ${skipped} ignoradas.`,
    ...
    cron: {
        ...
        fieldTimeout: 'Tempo limite (minutos)',
        fieldAllowedTools: 'Ferramentas permitidas',
        tierTrusted: 'Confiável (autônomo)',
        tierSupervised: 'Supervisionado (pergunta)',
        delete: 'Excluir agendamento',
        deleteConfirm: 'Excluir este agendamento? Nenhuma execução adicional será enfileirada.',
        deleteError: 'Não foi possível excluir o agendamento. Tente novamente.',
        ...
        cronExprInvalid: 'Uma expressão cron precisa de cinco campos separados por espaços (ex.: */30 * * * *).',
        promptPlaceholder: 'Descreva o que você quer que o agente faça…',
    ...
    event: {
        ...
        empty: 'Ainda não há assinaturas de eventos',
        submit: 'Nova assinatura',
        submitTitle: 'Nova assinatura de evento',
        fieldEventType: 'Tipo de evento',
        fieldMatchKey: 'Chave de correspondência',
        fieldDirectory: 'Diretório',
        fieldPrompt: 'Prompt',
        fieldTier: 'Nível',
        fieldPreset: 'Predefinição',
        ...
        deleteConfirm: 'Excluir esta assinatura? Nenhuma execução adicional será acionada.',
        deleteError: 'Não foi possível excluir a assinatura. Tente novamente.',
        statusEnabled: 'Ativado',
        statusDisabled: 'Desativado',
        submitSuccess: 'Assinatura criada.',
        eventTypeHint: 'Nesta versão, apenas git.commit é suportado.',
        matchKeyPlaceholder: 'Opcional, ex.: o nome de um branch',
        matchKeyHint: 'Acionar apenas quando o payload do evento corresponder a esta chave. Deixe vazio para corresponder a todos.',
        promptPlaceholder: 'Descreva o que você quer que o agente faça…',
        allowedToolsPlaceholder: 'Opcional, separadas por vírgula',
        allowedToolsHint: 'Restringe o agente a estas ferramentas. Deixe vazio para o padrão da predefinição.',
        fieldDispositionTopic: 'Tópico de disposição',
