...
export const es: TranslationStructure = {
    ...
    subscriptions: {
        title: 'Suscripciones',
        machineRowTitle: 'Suscripciones',
        machineRowSubtitle: 'Cuentas de Claude en esta máquina',
        sectionAccounts: 'Cuentas',
        accountsFooter: 'Varias suscripciones de Claude en esta máquina. Las sesiones en la nube se enrutan a través de la cuenta elegida; se usa la predeterminada cuando no se selecciona ninguna.',
        defaultBadge: 'Predeterminada',
        noAccounts: 'Aún no hay cuentas',
        noAccountsSubtitle: 'Añade una suscripción de Claude para enrutar las sesiones en la nube a través de ella.',
        addAccount: 'Añadir cuenta',
        usage5h: '5 horas',
        usage7d: '7 días',
        usageUnknown: 'Uso desconocido',
        accountActionsTitle: ({ name }: { name: string }) => `Cuenta: ${name}`,
        setDefault: 'Establecer como predeterminada',
        remove: 'Eliminar cuenta',
        removeConfirmTitle: '¿Eliminar cuenta?',
        removeConfirmMessage: ({ name }: { name: string }) => `«${name}» se eliminará del almacén de esta máquina. Las sesiones en ejecución seguirán funcionando hasta que se cambien.`,
        migrateRow: 'Migrar sesiones en ejecución',
        addTitle: 'Añadir cuenta',
        addInstructionsTitle: 'Obtén un token de configuración',
        addInstructionsRun: 'Ejecuta `claude setup-token` en la máquina e inicia sesión.',
        addInstructions: 'Pega el token a continuación. Se cifra en el almacén y nunca sale del demonio.',
        nameLabel: 'Nombre',
        namePlaceholder: 'p. ej. trabajo, personal',
        nameRequired: 'Introduce un nombre para esta cuenta.',
        tokenLabel: 'Token de configuración',
        tokenPlaceholder: 'Pega aquí el claude setup-token',
        tokenRequired: 'Pega el token de configuración.',
        makeDefault: 'Hacer predeterminada',
        addButton: 'Añadir cuenta',
        migrateTitle: 'Migrar sesiones',
        migrateInstructions: 'Selecciona sesiones en ejecución y cámbialas a otra cuenta. El cambio es en vivo — sin reinicio.',
        migrateNoSessions: 'No hay sesiones en ejecución en esta máquina.',
        migrateUnbound: 'No vinculada a una cuenta',
        migrateSelectTarget: 'Cambiar a',
        migrateButton: ({ count }: { count: number }) => `Cambiar ${count} ${plural({ count, singular: 'sesión', plural: 'sesiones' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} cambiadas, ${skipped} omitidas.`,
    ...
    cron: {
        ...
        deleteError: 'No se pudo eliminar la programación. Inténtalo de nuevo.',
        ...
        cronExprInvalid: 'Una expresión cron necesita cinco campos separados por espacios (p. ej. */30 * * * *).',
        promptPlaceholder: 'Describe lo que quieres que haga el agente…',
    ...
    event: {
        ...
        deleteError: 'No se pudo eliminar la suscripción. Inténtalo de nuevo.',
        statusEnabled: 'Activado',
        statusDisabled: 'Desactivado',
        submitSuccess: 'Suscripción creada.',
