...
export const pl: TranslationStructure = {
    ...
    connect: {
        ...
        restoreInstructions: 'Wprowadź klucz tajny, aby przywrócić dostęp do swojego konta.',
    ...
    subscriptions: {
        title: 'Subskrypcje',
        machineRowTitle: 'Subskrypcje',
        machineRowSubtitle: 'Konta Claude na tej maszynie',
        sectionAccounts: 'Konta',
        accountsFooter: 'Wiele subskrypcji Claude na tej maszynie. Sesje w chmurze są kierowane przez wybrane konto; gdy żadne nie jest wybrane, używane jest domyślne.',
        defaultBadge: 'Domyślne',
        noAccounts: 'Brak kont',
        noAccountsSubtitle: 'Dodaj subskrypcję Claude, aby kierować przez nią sesje w chmurze.',
        addAccount: 'Dodaj konto',
        usage5h: '5 godzin',
        usage7d: '7 dni',
        usageUnknown: 'Nieznane zużycie',
        accountActionsTitle: ({ name }: { name: string }) => `Konto: ${name}`,
        setDefault: 'Ustaw jako domyślne',
        remove: 'Usuń konto',
        removeConfirmTitle: 'Usunąć konto?',
        removeConfirmMessage: ({ name }: { name: string }) => `„${name}” zostanie usunięte z magazynu tej maszyny. Działające sesje pozostaną aktywne, dopóki nie zostaną przełączone.`,
        migrateRow: 'Przenieś działające sesje',
        addTitle: 'Dodaj konto',
        addInstructionsTitle: 'Uzyskaj token konfiguracyjny',
        addInstructionsRun: 'Uruchom `claude setup-token` na maszynie i zaloguj się.',
        addInstructions: 'Wklej token poniżej. Jest szyfrowany w magazynie i nigdy nie opuszcza demona.',
        nameLabel: 'Nazwa',
        namePlaceholder: 'np. praca, prywatne',
        nameRequired: 'Podaj nazwę tego konta.',
        tokenLabel: 'Token konfiguracyjny',
        tokenPlaceholder: 'Wklej tutaj claude setup-token',
        tokenRequired: 'Wklej token konfiguracyjny.',
        makeDefault: 'Ustaw domyślne',
        addButton: 'Dodaj konto',
        migrateTitle: 'Przenieś sesje',
        migrateInstructions: 'Wybierz działające sesje i przełącz je na inne konto. Przełączenie odbywa się na żywo — bez restartu.',
        migrateNoSessions: 'Brak działających sesji na tej maszynie.',
        migrateUnbound: 'Niepowiązane z kontem',
        migrateSelectTarget: 'Przełącz na',
        migrateButton: ({ count }: { count: number }) => `Przełącz ${count} ${plural({ count, one: 'sesję', few: 'sesje', many: 'sesji' })}`,
        migrateResult: ({ remapped, skipped }: { remapped: number; skipped: number }) => `${remapped} przełączono, ${skipped} pominięto.`,
