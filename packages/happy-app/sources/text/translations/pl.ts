...
export const pl: TranslationStructure = {
    ...
    newSession: {
        ...
        createDirectoryBody: ({ directory }: { directory: string }) => `Katalog '${directory}' nie istnieje. Czy chcesz go utworzyć?`,
        preset: {
            tabCustom: 'Niestandardowa',
            tabPreset: 'Preset',
            chooseProfile: 'Wybierz preset',
            noProfiles: 'Brak presetów na tej maszynie. Zdefiniuj je w ~/.happy/profiles.json na hoście (zobacz dokumentację demona).',
    ...
    fleet: {
        ...
        waitsInTerminal: 'Oczekuje w terminalu',
        cleanup: {
            action: 'Wyczyść…',
            ...
            doneTitle: 'Czyszczenie zakończone',
            nothingTitle: 'Nie ma czego czyścić',
            nothingBody: 'Brak nieaktywnych sesji starszych niż 7 dni.',
        },
    },
    ...
    cron: {
        ...
        deleteError: 'Nie udało się usunąć harmonogramu. Spróbuj ponownie.',
        ...
        cronExprInvalid: 'Wyrażenie cron wymaga pięciu pól oddzielonych spacjami (np. */30 * * * *).',
        promptPlaceholder: 'Opisz co chcesz, żeby agent zrobił…',
    ...
    event: {
        ...
        deleteError: 'Nie udało się usunąć subskrypcji. Spróbuj ponownie.',
        statusEnabled: 'Włączone',
        statusDisabled: 'Wyłączone',
        submitSuccess: 'Utworzono subskrypcję.',
