...
export const en = {
    ...
    cron: {
        ...
        deleteError: 'Could not delete the schedule. Please try again.',
        statusEnabled: 'Enabled',
        statusDisabled: 'Disabled',
        cronExprPlaceholder: 'e.g. */30 * * * *',
        cronExprHint: 'Five-field cron expression, evaluated in the daemon timezone.',
        cronExprInvalid: 'A cron expression needs five space-separated fields (e.g. */30 * * * *).',
        promptPlaceholder: 'Describe what you want the agent to do…',
    ...
    event: {
        ...
        deleteError: 'Could not delete the subscription. Please try again.',
        statusEnabled: 'Enabled',
        statusDisabled: 'Disabled',
        submitSuccess: 'Subscription created.',
